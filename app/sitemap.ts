...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE.url}/blog/maillage-interne-cocon-semantique`, lastModified: new Date("2026-09-06"), changeFrequency: "yearly", priority: 0.65 },
    { url: `${SITE.url}/blog/audit-seo-comment-ca-marche`, lastModified: new Date("2026-09-03"), changeFrequency: "yearly", priority: 0.65 },
    { url: `${SITE.url}/blog/taux-de-conversion-landing-page`, lastModified: new Date("2026-09-01"), changeFrequency: "yearly", priority: 0.65 },
    { url: `${SITE.url}/blog/donnees-structurees-seo-guide`, lastModified: new Date("2026-08-26"), changeFrequency: "yearly", priority: 0.65 },
    ...
    { url: `${SITE.url}/blog/cout-creation-site-internet-2026`, lastModified: new Date("2026-08-03"), changeFrequency: "yearly", priority: 0.65 },
    { url: `${SITE.url}/blog/agence-seo-ou-freelance`, lastModified: new Date("2026-07-16"), changeFrequency: "yearly", priority: 0.65 },
